...
<head>
    ...
    <title> Home One || Roofsie || Roofsie HTML 5 Template </title>
    <!-- favicons Icons -->
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="assets/images/resources/logo-3.png" width="143" height="50"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:needhelp@packageName__.com">info@deltalpg.com</a>
                </li>
                <li>
    ...
    <!-- Template JS -->
    <script src="{{ asset('assets/js/roofsie.js') }}"></script>
</body>
