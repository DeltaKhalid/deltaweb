      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="adminasset/images/logo/logo-1.png" alt=""><img class="img-fluid for-dark" src="adminasset/images/logo/logo.png" alt=""></a></div>
            <div class="toggle-sidebar">
              <svg class="sidebar-toggle"> 
                <use href="adminasset/svg/icon-sprite.svg#stroke-animation"></use>
              </svg>
            </div>
          </div>
            ...
            <ul class="nav-menus">
              ...
              <li class="cart-nav onhover-dropdown">
                ...
                <div class="cart-dropdown onhover-show-div">
                  ...
                  <ul>
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-60" src="adminasset/images/ecommerce/06.jpg" alt="">
                    ...
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-60" src="adminasset/images/ecommerce/02.jpg" alt="">
                  ...
                  <ul>
                    <li>
                      <div class="d-flex align-items-start">
                        <div class="message-img bg-light-primary"><img src="adminasset/images/user/3.jpg" alt=""></div>
                    ...
                    <li>
                      <div class="d-flex align-items-start">
                        <div class="message-img bg-light-primary"><img src="adminasset/images/user/6.jpg" alt=""></div>
                        <div class="flex-grow-1">
                    ...
                    <li>
                      <div class="d-flex align-items-start">
                        <div class="message-img bg-light-primary"><img src="adminasset/images/user/10.jpg" alt=""></div>
                        <div class="flex-grow-1">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      ...
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-layout"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-project"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-project"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="file-manager.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-file"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-file"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack">        </i><a class="sidebar-link sidebar-title link-nav" href="kanban.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-board"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-board"></use>
                      </svg><span>kanban Board</span></a></li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-ecommerce"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-ecommerce"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-email"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-email"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-chat"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-chat"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-user"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-user"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="bookmark.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-bookmark"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-bookmark"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="contacts.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-contact"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-contact"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="task.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-task"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-task"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="calendar-basic.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-calendar"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-calender"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="social-app.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-social"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-social"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="to-do.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-to-do"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-to-do"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="search.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-search"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-search"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-form"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-form"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-table"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-table"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-ui-kits"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-ui-kits"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-bonus-kit"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-bonus-kit"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      ...
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-animation"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-icons"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-icons"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-button"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-button"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-charts"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-charts"></use>
                  ...
                  <li class="mega-menu sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      ...
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-others"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-gallery"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-gallery"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-blog"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-blog"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="faq.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-faq"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-faq"></use>
                      </svg><span>FAQ</span></a></li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-job-search"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-job-search"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-learning"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-learning"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-maps"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-maps"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-editors"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-editors"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="knowledgebase.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-knowledgebase"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="adminasset/svg/icon-sprite.svg#fill-knowledgebase"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="support-ticket.html">
                      <svg class="stroke-icon">
                        <use href="adminasset/svg/icon-sprite.svg#stroke-support-tickets"></use>
                      </svg>
                      <svg class="fill-icon">
                ...
                <div class="row bg-light h-100 p-3 pt-4 pb-4">
                    ...
                    <div class="card welcome-card">
                      <div class="card-body">
                        <div class="d-flex"> 
                          ...
                          <div class="flex-shrink-0"> <img src="adminasset/images/dashboard/welcome.png" alt=""></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-xl-12 col-xl-50 col-md-6 box-col-6">
                    <div class="card news-update">
                      ...
                      <div class="card-body">
                        <div class="d-flex align-items-center pt-0"><img src="adminasset/images/dashboard/1.jpg" alt="">
                        ...
                        <div class="d-flex align-items-center"><img src="adminasset/images/dashboard/2.jpg" alt="">
                          <div class="flex-grow-1 ms-3"><a href="social-app.html">
                        ...
                        <div class="d-flex align-items-center"><img src="adminasset/images/dashboard/3.jpg" alt="">
                          <div class="flex-grow-1 ms-3"><a href="social-app.html">
                        ...
                        <div class="d-flex align-items-center"><img src="adminasset/images/dashboard/4.jpg" alt="">
                          <div class="flex-grow-1 ms-3"><a href="social-app.html">
                              <h5>Indonesian Navy Lauds Mental Perseverance of Teenager...</h5><span>Today's News Headlines, Breaking...</span></a></div>
                          <div class="flex-shrink-0"> 
                      ...
                      <div class="card-body money">
                        <div class="customer-card d-flex b-l-secondary border-2">
                          ...
                          <div class="dashboard-user bg-light-secondary"><span></span>
                            <svg>
                              <use href="adminasset/svg/icon-sprite.svg#money"></use>
                            </svg>
                          </div>
                        </div>
                        <div class="customer mt-2"><span class="me-1">
                      ...
                      <div class="card-body profit">
                        <div class="customer-card d-flex b-l-danger border-2">
                          ...
                          <div class="dashboard-user bg-light-danger"><span></span>
                            <svg>
                              <use href="adminasset/svg/icon-sprite.svg#profile"></use>
                            </svg>
                          </div>
                        </div>
                        <div class="customer mt-2"><span class="me-1">
                            <svg>
                              <use href="adminasset/svg/icon-sprite.svg#arrow-down"></use>
